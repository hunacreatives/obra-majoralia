...
const Footer = ({ nightMode = false }: FooterProps) => {
  const bg = nightMode ? '#0d0d0d' : '#383838';
  const divider = nightMode ? '#2a2a2a' : '#555555';

  return (
    <footer className="w-full overflow-visible transition-colors duration-700" style={{ backgroundColor: bg }}>
